  ...
  return (
    <>
     ...
     <div className="w-full h-screen">
        <Image className="hidden sm:block absolute w-full h-full object-cover" src={Banner} alt="Sign Up"/>
        <div className="main-overlay w-full h-screen bg-black/60 fixed top-0 left-0"></div>
        <div className="sign-form-section fixed w-full px-4 py-24 z-50">
            <div className="form-bg max-w-[450px] h-[600px] mx-auto bg-black/75 text-white">
                <div className="main-form max-w-[320px] mx-auto py-16">
                    ...
                    <form action="" className="w-full flex flex-col py-4">
                        ...
                        <input className="p-3 my-2 bg-gray-700 rounded" type="text"  placeholder="Phone Number" />
                        <select className="p-3 my-2 bg-gray-700 rounded" placeholder="Select Country">
                          <option>Select Country</option>
                          <option>India</option>
                          <option>United States</option>
                          <option>United Kingdom</option>
                          <option>Saud Arabia</option>
                          <option>Iceland</option>
                          <option>Japan</option>
                          <option>China</option>
                          <option>Australiya</option>
                        </select>
                        <button className="bg-red-600  text-white  py-2 my-2 rounded font-bold">Sign Up</button>
                    </form>
                    ...
                    <p className="py-8 text-red-600"><span className="text-gray-600 text-sm">Already Subscribed to Netflix?</span> <Link href={'/login'} >Sign In</Link></p>
